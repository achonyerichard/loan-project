...
const UserWithdrawalCards = () => {
  const [data] = useApi(
    "https://thriftandloan.onrender.com/api/transaction/mywithdraw"
  );
    ...
    <div>
      ...
      <section className="grid md:grid-cols-2 xl:grid-cols-3 gap-6">
        ...
        <div className="flex items-center p-8 bg-white shadow rounded-lg">
          ...
          <div>
            <span className="block text-2xl font-bold text-gray-500">
              {data.length - filterConfirmed.length}
            </span>
...
export default UserWithdrawalCards;
